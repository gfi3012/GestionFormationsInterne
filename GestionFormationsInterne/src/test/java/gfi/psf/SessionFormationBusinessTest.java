...
import gfi.psf.business.ISessionFormationBusiness;
...
public class SessionFormationBusinessTest {
	...
	@Autowired
	private ISessionFormationBusiness sessionFormationBusiness;
	@Autowired
	...
	// List<SessionFormation> listSessionFormation1 = sessionFormationRepository
	// .findAll();
	// sessionFormationBusiness.creerSessionFormation(new SessionFormation(
	// new Date(), new Date(), 20, "lieu1"));
	// sessionFormationBusiness.creerSessionFormation(new SessionFormation(
	// new Date(), new Date(), 10, "lieu2"));
	// List<SessionFormation> listSessionFormation2 = sessionFormationRepository
	// .findAll();
	// assertTrue(listSessionFormation1.size() + 2 == listSessionFormation2
	// .size());
	// }
